...
} from "../application/update-transaction.schema";
import { updateTransactionAction } from "./update-transaction.actions";
...
export function UpdateTransactionForm({
  ...
  const {
    ...
    defaultValues: {
      ...
      occurredAt: getLocalDateTimeValue(transaction.occurredAt),
  ...
  async function onSubmit(updatedTransaction: UpdateTransactionInput) {
  ...
  return (
    <form className="space-y-5" onSubmit={handleSubmit(onSubmit)} noValidate>
      ...
      {financialAccounts.length === 0 && (
        <output className="block text-sm">Nenhuma conta financeira ativa está disponível.</output>
      )}
